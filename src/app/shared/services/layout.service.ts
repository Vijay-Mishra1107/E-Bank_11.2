...
export interface ILayoutConf {
  ...
  sidebarColor?: string; // Sidebar background color http://demos.ui-lib.com/WiproBank-doc/#WiproBank-colors
  ...
  topbarColor?: string; // Header background color http://demos.ui-lib.com/WiproBank-doc/#WiproBank-colors
  footerColor?: string; // Header background color http://demos.ui-lib.com/WiproBank-doc/#WiproBank-colors
  matTheme?: string; // material theme. WiproBank-blue, WiproBank-navy, WiproBank-dark-purple, WiproBank-dark-pink
  ...
  constructor(private themeService: ThemeService) {
    this.setAppLayout(
      //******** SET YOUR LAYOUT OPTIONS HERE *********
      {
        ...
        sidebarColor: "slate", // http://demos.ui-lib.com/WiproBank-doc/#WiproBank-colors
        sidebarCompactToggle: false, // applied when "sidebarStyle" is "compact"
        useBreadcrumb: true,
        footerFixed: true,
        topbarColor: "purple", // http://demos.ui-lib.com/WiproBank-doc/#WiproBank-colors
        footerColor: "slate", // http://demos.ui-lib.com/WiproBank-doc/#WiproBank-colors
        matTheme: "WiproBank-light-purple", // WiproBank-blue, WiproBank-navy, WiproBank-light-purple, WiproBank-dark-purple, WiproBank-dark-pink
